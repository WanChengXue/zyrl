...
def test_mc():
    ...
    mc_config = {
        "saved_q_table_path": f"./data/split_state_action_data_index/q_table_{env_type}.csv",
        "saved_count_table_path": f"./data/split_state_action_data_index/count_table_{env_type}.csv",
        "gamma": 0.99,
        "sample_env_num": 30,
        "mse_loss_plot_path": f"./data/split_state_action_data_index/mse_loss_plot_{env_type}.png",
    }
