...
class BacktestWorker:
    ...
    def _init_env(self):
        self._env = SplitStateActionEnv(self._config["env_config"])
...
if __name__ == "__main__":
    config = {
        "q_table_path": {
            "open_long_table_path": "./data/split_state_action_data_index/q_table_open_long.csv",
            "open_short_table_path": "./data/split_state_action_data_index/q_table_open_short.csv",
            "close_long_table_path": "./data/split_state_action_data_index/q_table_close_long.csv",
            "close_short_table_path": "./data/split_state_action_data_index/q_table_close_short.csv",
        },
        "env_config": {
            "training_data_path": "data/split_state_action_data",
    ...
    plt.show()
    plt.savefig("./figure/cusum_reward_20250901.png")
    plt.close()
