...
def init_mask_table():
    ...
    state_table_index_list = [i for i in range(6 * 6 * 6 * 6 * 6)]
        ...
        for delta2 in [0, 0.2, 0.4, 0.6, 0.8, 1]:
            for delta3 in [0, 0.2, 0.4, 0.6, 0.8, 1]:
                for delta4 in [0, 0.2, 0.4, 0.6, 0.8, 1]:
                    for delta5 in [0, 0.2, 0.4, 0.6, 0.8, 1]:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_folder", type=str, default="delta3/im_20250905")
    parser.add_argument(
        "--index_folder", type=str, default="delta5/state_index_with_delta5"
    )
    parser.add_argument(
        "--result_folder", type=str, default="delta5/im_20250905_delta5_only_result"
    )
